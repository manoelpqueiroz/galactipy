...
??? warning
    ...
    before sending.
<!-- RECORD your key data and replacing the commands below with their output
    **Key fingerprint:**
...
<!-- RECORD your supported versions for security reporting -->
...
<!-- RECORD your project's use cases
...
{% if cookiecutter.__app_class == 'bare' -%}
<!-- RECORD with guarantees your project and upstream dependencies give in regards to security -->
