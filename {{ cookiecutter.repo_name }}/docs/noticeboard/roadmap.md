...
and anticipate future changes required
by our releases.
...
**Planning** stage,
refining its foundational features
...
[1]: https://img.shields.io/pypi/status/{{ cookiecutter.repo_name }}?style=for-the-badge&logo=theplanetarysociety&label=stage
