...
> **Proposed Version:** `{{ cookiecutter.__version_s3 }}` <!-- Provide next expected {{ cookiecutter.__version_s3.lower() }} version -->
...
[4]: {{ cookiecutter.__scm_repo_latch }}/projects
...
> - [ ] The proposed {{ cookiecutter.project_name }} version adheres to our view on [{{ cookiecutter.__schema_cipher }}][12].
...
[12]: {{ cookiecutter.__scm_repo_latch }}/blob/master/CONTRIBUTING.md#versioning-customs
