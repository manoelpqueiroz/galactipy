...
- [:sparkles: Add tag support for template docs](galactipy/galactipy@e179c8618f3a34b4b6578429d67168b3b9b0d54f) ([merge request](galactipy/galactipy!207))
- [:art: Wrap `AsyncStepConverter` logic inside function](galactipy/galactipy@f186712a16c27fed97085b6b66853d00fbc8adea) ([merge request](galactipy/galactipy!207))
- [:art: Keep internal objects isolated in their packages](galactipy/galactipy@e096ba93e2c64deff8fc67b4988fa416a95de088) ([merge request](galactipy/galactipy!207))
- [:sparkles: Add documentation section for public announcements](galactipy/galactipy@5fa1c343e76bff756fc559727447729533ecc807) ([merge request](galactipy/galactipy!207))
- [:truck: Turn log parsers into public API objects](galactipy/galactipy@e3dc855e0410ff96164993cb65284130e882f3b6) ([merge request](galactipy/galactipy!207))
- [:sparkles: Add reference guide for development objects](galactipy/galactipy@4d6ac30e7ce4a0cf50567f86db8393be9febd385) ([merge request](galactipy/galactipy!207))
- [:technologist: Add Invoke commands in development documentation](galactipy/galactipy@3f45d010f030fb0f9cea925194301cc04170d5a3) ([merge request](galactipy/galactipy!207))
- [:pencil: Add pages for template public API](galactipy/galactipy@641d09dc9164b1ccb31280aa9de67b03e7a86195) ([merge request](galactipy/galactipy!207))

### :metro: Template Internals (22 changes)

- [:wrench: Define documentation tags](galactipy/galactipy@4320bd44c48ab1a7d5e0f690cca058edbba2ae75) ([merge request](galactipy/galactipy!207))
- [:wrench: Update Zensical navigation splitting pages for non-OSS licence](galactipy/galactipy@921266fb5414a3fb4128665c3b5b66d44cca9189) ([merge request](galactipy/galactipy!207))
- [:adhesive_bandage: Add missing page on documentation changes](galactipy/galactipy@81a198a62171f75748b68694d085ecf7245b9680) ([merge request](galactipy/galactipy!207))
- [:wrench: Update Zensical navigation with security guide and noticeboard](galactipy/galactipy@25735a54cb549272911cf158510dad746d876479) ([merge request](galactipy/galactipy!207))
- [:wrench: Update Zensical navigation with documentation guide](galactipy/galactipy@cded81ed50ea6e926ea6f1f9707644e3bdb866d8) ([merge request](galactipy/galactipy!207))
- [:wrench: Update Zensical navigation with dev packages section](galactipy/galactipy@af3e2a33f2e28efe518d1189d35b5a6a1fb88ad1) ([merge request](galactipy/galactipy!207))
- [:wrench: Update Zensical navigation for CLI guide](galactipy/galactipy@fe1dbf9f2453ddbc07267dbe4d4a66621b70dfb4) ([merge request](galactipy/galactipy!207))
- [:wrench: Add development guide pages to Zensical navigation](galactipy/galactipy@fb85aa1edea0d83bed156a9ae3634df3d003431d) ([merge request](galactipy/galactipy!207))
- [:wrench: Enable keyboard key rendering for documentation](galactipy/galactipy@d194ca45854f0aeaa32c5a41baf7b57626cf93aa) ([merge request](galactipy/galactipy!207))
- [:wrench: Enable footnotes for template documentation](galactipy/galactipy@6218044916ee7554dde2995d6075639435a96c03) ([merge request](galactipy/galactipy!207))
- [:wrench: Add Zensical configuration for code highlighting support](galactipy/galactipy@8019b13da25baaae92a7b822bc031cf330e2fd07) ([merge request](galactipy/galactipy!207))
- [:wrench: Add Zensical configuration for Markdown content](galactipy/galactipy@ddbc99a9560f980b7210e29bc89efeb57092019e) ([merge request](galactipy/galactipy!207))
- [:wrench: Add support for search highlighting and tables for template documentation](galactipy/galactipy@c84b607ca506e6d534dcfda4c5cdf6cdd6f2ca56) ([merge request](galactipy/galactipy!207))
- [:wrench: Add configuration for Zensical tables of contents](galactipy/galactipy@93b52b64294c9d0713e34aa7fa2065ab8438ecad) ([merge request](galactipy/galactipy!207))
- [:wrench: Update Zensical navigation pages with template API](galactipy/galactipy@4f28adf68a68bfa71e78b0ec17c71efe9a4ed080) ([merge request](galactipy/galactipy!207))
- [:wrench: Configure Zensical for API collection and formatting](galactipy/galactipy@219c2d9861aad6d99e2a1c9a53cc70776dfdc1c3) ([merge request](galactipy/galactipy!207))
- [:wrench: Add copyright notice and social link captions for documentation](galactipy/galactipy@a273ab9feba1bd167ac215b8a911ea990bc974c6) ([merge request](galactipy/galactipy!207))
- [:wrench: Create additional Todo tag for documentation comments](galactipy/galactipy@f781c0dae2503706a2ca55c3f513e9621c987fc3) ([merge request](galactipy/galactipy!207))
- [:wrench: Include social links in template documentation](galactipy/galactipy@9edf20665c0716d57afaa93bf8b72b85b902f8f9) ([merge request](galactipy/galactipy!207))
- [:wrench: Define default code font for documentation](galactipy/galactipy@8d6c008ebca6209891c1d8d0adf32a2b76536340) ([merge request](galactipy/galactipy!207))
- [:wrench: Define default documentation navigation features](galactipy/galactipy@7b1c6eb0b5cd2f3cddc741f3a47dc1b1ce72abad) ([merge request](galactipy/galactipy!207))
- [:wrench: Add initial Zensical configuration](galactipy/galactipy@fcf7c0f078fc526129a5ced64b0f316237737033) ([merge request](galactipy/galactipy!207))

### :ballot_box: Settings & Options (8 changes)

- [:shinto_shrine: Add Jinja conditionals for docs creation option](galactipy/galactipy@d1b0d0a4b3e8915bc95c7fee8cdb4cc66ed539a2) ([merge request](galactipy/galactipy!208))
- [:shinto_shrine: Add conditionals for documentation sections in configuration files](galactipy/galactipy@e3303e5453a852dbe2c488fb3b2f2ede8b3a4816) ([merge request](galactipy/galactipy!208))
- [:cookie: Add option to generate documentation](galactipy/galactipy@a7e14c23a8dc7cdc45ebebdfeea24c6f16c75fa9) ([merge request](galactipy/galactipy!208))
- [:shinto_shrine: Remove licence Jinja conditionals for development guide](galactipy/galactipy@2da58a133758dc7c5081328f034dd82e73407a7f) ([merge request](galactipy/galactipy!207))
- [:shinto_shrine: Apply application type conditionals on documentation contents](galactipy/galactipy@087b0394ab0fc87f86eb54cd0a382f31cd268fa0) ([merge request](galactipy/galactipy!207))
- [:cookie: Streamline template `CONTRIBUTING.md` variables in Cookiecutter config](galactipy/galactipy@0c4d208c4ab41cf2146178628512adc17eb968da) ([merge request](galactipy/galactipy!207))
- [:heavy_plus_sign: Add mkdocstrings as a template dependency](galactipy/galactipy@a4e4e0e00c3701218ae50da9833908f25d098e56) ([merge request](galactipy/galactipy!207))
- [:heavy_plus_sign: Add Zensical as a template dependency](galactipy/galactipy@7f84052aa5685d4638a77a7aac9bfbc1348df30b) ([merge request](galactipy/galactipy!207))

### :toolbox: Fixes (6 changes)

- [:speech_balloon: Fix docstrings for post-gen hooks](galactipy/galactipy@24bd2db715396c3152a2a6fd8faafd06d16a9b6e) ([merge request](galactipy/galactipy!207))
- [:adhesive_bandage: Adjust text and formatting for documentation files](galactipy/galactipy@b1e24ea51422b6a947206b4358214eeca334a60b) ([merge request](galactipy/galactipy!207))
- [:bug: Fix post-gen hooks to adequate new project structure](galactipy/galactipy@dd6db38949783669abf866c315fabd6e2fdf32ec) ([merge request](galactipy/galactipy!207))
- [:adhesive_bandage: Fix template docs internal links](galactipy/galactipy@20b04b0a48eed6d9b8df56cf63a82badc90ee9f5) ([merge request](galactipy/galactipy!207))
- [:adhesive_bandage: Update minor elements for template documentation](galactipy/galactipy@cb22948f1cc294e3ef1152db783b871948795595) ([merge request](galactipy/galactipy!207))
- [:pencil2: Fix non-string values for docs social links](galactipy/galactipy@40d1e3474db4bfe09219db36b6b5718f58a01acd) ([merge request](galactipy/galactipy!207))

### :factory_worker: Template Maintenance (1 change)

- [:truck: Reorganise internal template objects](galactipy/galactipy@9223a570741a5c676c156a0fef017683357c7a00) ([merge request](galactipy/galactipy!207))

### :gear: Project Internals (4 changes)

- [:hammer: Update post-gen hooks with documentation removal](galactipy/galactipy@a79c609861e21c209f4666928193f32f295f3150) ([merge request](galactipy/galactipy!208))
- [:hammer: Update post-gen hooks for documentation files removal](galactipy/galactipy@ad8e62b10d158e42ac61d6cbf0ce6cb7469121b5) ([merge request](galactipy/galactipy!207))
- [:wrench: Streamline Docker references for the template](galactipy/galactipy@85ee1614eb1613ace56112e92985435278d635f1) ([merge request](galactipy/galactipy!207))
- [:truck: Move Sphinx flag content to a dedicated directory](galactipy/galactipy@b719d9f4af32603edd9beaf199740de177c27000) ([merge request](galactipy/galactipy!207))

### :airplane_departure: Release Cycle Optimisation (1 change)

- [:construction_worker: Remove automerge setting step for GitHub mirror job](galactipy/galactipy@32f45161579c66ee464639a70bea1f03cf9fb11a)

### :repeat: Design & Validation (3 changes)

- [:white_check_mark: Update unit tests for full documentation removal](galactipy/galactipy@366a89fee5976ee9ad038ffb53b12e8a28ea2807) ([merge request](galactipy/galactipy!208))
- [:white_check_mark: Add file removal tests for documentation](galactipy/galactipy@9091016d07fa16000d125ce26f303eea5c83590e) ([merge request](galactipy/galactipy!207))
- [:bento: Add initial Markdown files for documentation](galactipy/galactipy@a7189a6c3a749a35a5fecdedf7bfc0fea613713f) ([merge request](galactipy/galactipy!207))

### :pouring_liquid: Nits (16 changes)

- [:shinto_shrine: Adjust Jinja whitespace control](galactipy/galactipy@8188e80100460ff75331df18df8f44af4a8f82b6) ([merge request](galactipy/galactipy!208))
- [:adhesive_bandage: Include conditionals for different version schemas in `CITATION.cff`](galactipy/galactipy@b3166f2c80306640809445c57cb2360b7c8437b5)
- [:pencil2: Fix missing Cookiecutter variables in Markdown files](galactipy/galactipy@91faffee92e198ff44a124e86991eb710e20e465)
- [:shinto_shrine: Refine Zensical navigation to comply with template structure](galactipy/galactipy@47d2e7448e62aa30c7795a908bfdfe87862cbd0c) ([merge request](galactipy/galactipy!207))
- [:shinto_shrine: Refine GitLab Premium/Ultimate content in template `CONTRIBUTING.md`](galactipy/galactipy@edbbfa51516e1ee167bd8d38a4e326390bda2e64) ([merge request](galactipy/galactipy!207))
- [:shinto_shrine: Update `CONTRIBUTING.md` content for non-OSS licences](galactipy/galactipy@369d83d30e8494968deae6dc4245b7fd6668f625) ([merge request](galactipy/galactipy!207))
- [:speech_balloon: Add icons to security guide headers in template docs](galactipy/galactipy@3dbc47cd572cc930eb01a836164125b68096bc12) ([merge request](galactipy/galactipy!207))
- [:pencil2: Fix HTML alignment in template docs](galactipy/galactipy@69d4d01d07a88a82a6a9d13b769bd40671aeb283) ([merge request](galactipy/galactipy!207))
- [:pencil2: Fix typos in template docs](galactipy/galactipy@6557a1feb9e5074997a7d925450378d096439c39) ([merge request](galactipy/galactipy!207))
- [:adhesive_bandage: Fix anchor name in template `CONTRIBUTING.md`](galactipy/galactipy@8568d32247d10eb12ee46dcd26d4863eae68fc2a) ([merge request](galactipy/galactipy!207))
- [:shinto_shrine: Fix uncaught Jinja misuses in template `CONTRIBUTING.md`](galactipy/galactipy@cf4b8ad8d15097fbb16181737e70e3ce34849866) ([merge request](galactipy/galactipy!207))
- [:adhesive_bandage: Modify settings to prevent Codespell false positive](galactipy/galactipy@554d16b023ebc6555b6872b6b8f3cc405c2c384f) ([merge request](galactipy/galactipy!207))
- [:pencil: Update template `CONTRIBUTING.md` with streamlined variables](galactipy/galactipy@7b0972cdd6bb36c68ac569b0cc98fe177eb56b57) ([merge request](galactipy/galactipy!207))
- [:pencil2: Correct optional argument syntax in template `README.md`](galactipy/galactipy@b51d839a5fd91fad995d6befefe09b85d395f44a) ([merge request](galactipy/galactipy!207))
- [:pencil2: Fix `zensical.toml` table bracket spacing](galactipy/galactipy@4088fee020ec386a3d97091d87c4f618aa2cc154) ([merge request](galactipy/galactipy!207))
- [:adhesive_bandage: Add spacing in template `zensical.toml`](galactipy/galactipy@94c0b321d125ceaaccdbdf9abadb576a93ec6f14) ([merge request](galactipy/galactipy!207))

### :books: Documentation (28 changes)

- [:pencil: Update project `README.md` with documentation feature](galactipy/galactipy@70b4ff40fb8951b2bec75dbb2a802dd7dc764a63) ([merge request](galactipy/galactipy!208))
- [:pencil: Update template `README.md` file with documentation content](galactipy/galactipy@56ea9105f7d977a0e7879afd03064025b4e59fa0) ([merge request](galactipy/galactipy!208))
- [:bulb: Add cross-reference comments for mirrored GitLab Premium content](galactipy/galactipy@7fb4bbe47b69ca1fc320058e11e7646f4c027d44) ([merge request](galactipy/galactipy!207))
- [:bulb: Add cross-reference comments for mirrored content in template docs](galactipy/galactipy@f3df75a0ca6a49342a718c552a76c6442fcf452b) ([merge request](galactipy/galactipy!207))
- [:pencil: Update section on checks listing all pre-commit hooks](galactipy/galactipy@2084212e287e7b7b2e078a6d67e6892f03512339) ([merge request](galactipy/galactipy!207))
- [:pencil: Add section detailing documentation tags in template `CONTRIBUTING.md`](galactipy/galactipy@606849fd2bbacb173ca1cc26137e6db31d57a0c4) ([merge request](galactipy/galactipy!207))
- [:shinto_shrine: Refine non-OSS content in template `ROADMAP.md`](galactipy/galactipy@4cc051bdc4690ab5f41fc085d98f4a1d5a3a6b1b) ([merge request](galactipy/galactipy!207))
- [:shinto_shrine: Refine non-OSS content in template `CONTRIBUTING.md`](galactipy/galactipy@caff3253da5c2d447ae1e1961b4e810a41ffe516) ([merge request](galactipy/galactipy!207))
- [:pencil: Update "Acknowledgements" section for project `README.md`](galactipy/galactipy@5de283690df0194c66403a3903eca7ccedc0010f) ([merge request](galactipy/galactipy!207))
- [:pencil: Update documentation security guide with internal links](galactipy/galactipy@40479a20e83e790150d0cdf55a177248a5a45335) ([merge request](galactipy/galactipy!207))
- [:pencil: Add security guide to template documentation](galactipy/galactipy@09e1bedee64154be97ea77d613b4ca1d202ddf03) ([merge request](galactipy/galactipy!207))
- [:pencil: Update template `SECURITY.md` supported versions for each schema](galactipy/galactipy@f4c0d77459ec31e1f9a52bbc1ec230feabc1f5cf) ([merge request](galactipy/galactipy!207))
- [:pencil: Create pages for documentation guide](galactipy/galactipy@96ad738d4ad67eee7e6c10fa142bac0d13dc3027) ([merge request](galactipy/galactipy!207))
- [:pencil: Add individual documentation for log parsers](galactipy/galactipy@edd8388c3ca769fe5095b10ac64cde26099a902c) ([merge request](galactipy/galactipy!207))
- [:pencil: Add guidelines and policies for template documentation](galactipy/galactipy@c18fd212617d381717bd913f2e6eb0e713ec1675) ([merge request](galactipy/galactipy!207))
- [:pencil: Reorganise development workflow content](galactipy/galactipy@95b0548efc5bfe654b74ef16cebf58ec3b7f1427) ([merge request](galactipy/galactipy!207))
- [:pencil: Add docstrings for `tests.utils` objects](galactipy/galactipy@564ebf2df88de671653ed359a2b247c9b802d1fb) ([merge request](galactipy/galactipy!207))
- [:pencil: Update section on documentation help on template `CONTRIBUTING.md`](galactipy/galactipy@81b79956c72be85d0131364ff38e7f6e8b468f3a) ([merge request](galactipy/galactipy!207))
- [:pencil: Restructure CLI section in template documentation](galactipy/galactipy@0eece38a05e181d1fa9608f33b17ba47d48fbacd) ([merge request](galactipy/galactipy!207))
- [:pencil: Reduce content on CLI usage in template `README.md`](galactipy/galactipy@b077657c4f8c8036ff1ae0e863fd768f02634510) ([merge request](galactipy/galactipy!207))
- [:pencil: Update template `CONTRIBUTING.md` with Invoke commands](galactipy/galactipy@086809b4486113625e13b88d280f707e839341e0) ([merge request](galactipy/galactipy!207))
- [:pencil: Add minimal content for release history page in template documentation](galactipy/galactipy@47e453de0cfdd4f125becdd32e9825504db361ea) ([merge request](galactipy/galactipy!207))
- [:pencil: Add documentation for the template development guide](galactipy/galactipy@9e7099ae5c243abeba39ea29a0966f607e684ea1) ([merge request](galactipy/galactipy!207))
- [:pencil: Complement page on community tutorials with RFI links](galactipy/galactipy@b9c3d1d1cadde94126a6efb8ffb5ef444535b846) ([merge request](galactipy/galactipy!207))
- [:pencil: Add documentation for the "User Guide" section](galactipy/galactipy@4609137fa34473f1d0beeef9a324407d2a7ae716) ([merge request](galactipy/galactipy!207))
- [:pencil: Add remaining documentation content for the "Getting Started" section](galactipy/galactipy@cd2d17dd751012e3bcc15aa72814f7fd222788dc) ([merge request](galactipy/galactipy!207))
- [:pencil: Add documentation homepage content](galactipy/galactipy@0f88b7a00ea34d05739a01d5cf9f2ff4e189b333) ([merge request](galactipy/galactipy!207))
- [:pencil: Add basic content on project introduction](galactipy/galactipy@ab6aed243eafcaf2d8fe065a883e09c341f7a841) ([merge request](galactipy/galactipy!207))
...
- [:construction_worker: Update actions/cache action to v2.1.8](galactipy/galactipy@9172cae9962684b322038b1f8e26f67308ea7670) ([merge request](galactipy/galactipy!110))
...
- [:arrow_up: Update dependency invoke to v2.2.1](galactipy/galactipy@4a66af69ab74de84f20afbed0c020cad431995a4) ([merge request](galactipy/galactipy!111))
...
- [:art: Improve Python version support resolution](galactipy/galactipy@b77ef48440b82958bccdab276248ac485f0516df) ([merge request](galactipy/galactipy!103))
- [:art: Refine terms used for licences](galactipy/galactipy@fbd89c6cea0cc36e4ea64a1e4cbc5955ee4d8f97) ([merge request](galactipy/galactipy!103))

### :scroll: Project Policies (1 change)

- [:pencil: Adopt Romantic Versioning for the project](galactipy/galactipy@9191aa83399b7b72d9a7da8cdf7af57e2f335f11)
...
- [:construction_worker: Correct and simplify PyPI triggers for GitHub](galactipy/galactipy@13929207c8ac34663df1b1f2e24c29d10c590b07) ([merge request](galactipy/galactipy!31))
...
- [:rotating_light: Select pycodestyle rules for project](galactipy/galactipy@01fa2bad647549c0b49deca186c519247d2a6a72) ([merge request](galactipy/galactipy!18))
...
- [:heavy_minus_sign: Remove coverage-badge from dependencies](galactipy/galactipy@99a5d77b2dbd5f9dda22a3a1988df45f55750b49) ([merge request](galactipy/galactipy!6))
